...
<link rel="stylesheet" href="/css/style.css?v=1"  type="text/css" media="" />
...
<body>
  ...
  <section class="sec-header head-mob px-4 d-lg-none d-block">
    <nav class="navbar navbar-expand-lg navbar-light   ">
      ...
      <a class="navbar-brand mx-auto" href="/"><img src="/images/logo.png"
       alt="Inutation4U logoo " class="w-100 d-md-block d-none">
