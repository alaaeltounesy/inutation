...
<head>
    ...
    <meta name="keywords" content="nutrition   , diet   , diabetes   , overweight   , underweight   , food  , health  , health issues   , mellitus   , health problems
    ...
    <section class="sec-links">
        <div style="background-color:#FFF0EC;">


            <div class="container-fluid w-85    py-3">
    ...
    <div class="d-xl-block d-none" style="width: 100%;
     height: 100px;">
    ...
    <section class="bg-ser2 py-5 mt-xl-5">
        <div class="container-fluid py-xl-5  w-85 ">
    ...
    <section class="services my-xl-5 mb-5  p-md-0 px-2">
        ...
        <div class="cardser6 cardser w-85 " id="Meal-Planning">
            <div class="container-fluid   py-md-5 py-5  fade-s   mt-5 s6">
                <div class="row py-lg-5 text-center justify-content-center">
    ...
    <div class="container-fluid w-85  py-md-5 py-5 mt-5 ">
        <div class="row py-xl-5 text-center justify-content-center">

            <div class="col-lg-10 col-12 p-lg-0">
                <h2 class="mb-3 green SemiBold">
