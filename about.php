                    ...
                    <div class="mt-lg-5">
                        ...
                        <p class="my-lg-5 my-3 italic-light-m " style="font-size:18px;">
                            ...
                            <span class="read-text">
                                ...
                                Shadia graduated from Florida International University with a bachelor’s degree in Dietetics & Nutrition in 2011 and a master’s degree in Dietetics & Nutrition in 2020. She has also earned a Pediatric Nutrition Certificate. After completing a dietetic internship program in 2012, Shadia became a registered dietitian/nutritionist and started working at the Health Department. In 2015, Shadia became the supervisor of Lantana clinic WIC (Women, Infants, and Children). In 2017, Shadia achieved the Adult Weight Management Certificate. In 2018, she became a Certified Lactation Consultant. From 2018 to 2019, she supervised both Lantana and Delray Beach clinics. Currently, in 2018, she became the site supervisor of Delray Beach WIC clinic in Palm Beach County, FL., a Certified Lactation Consultant Shadia has been recognized every year by Pasco County in appreciation for precepting dietetic student interns from 2015 to the present.
                            </span>
            ...
            <div class="row ">
                ...
                <div class="col-lg-6 p-0">
                    ...
                    <div class="  mx-0 row p-5 justify-content-center bor-peach   border-nb border-nr">
                        ...
                        <h4 class="my-auto bold-m col-10 "> How did you find the Nutrition field interesting to you?
                        ...
                        <p class=" italic-light-m col-12 " style="font-size:18px;">
                            ...
                            “Let <span class="bold">food</span> be thy medicine, and let medicine be thy <span class="bold">food</span>.”
                            The Greek physician Hippocrates, a famous <span class="bold"> philosopher. </span>
                            <br>
                            <br>
                    ...
                    <div class=" mx-0 row p-5 justify-content-center bor-peach  border-nr">
                        ...
                        <h4 class="my-auto bold-m col-10 "> What makes you unique?
                        </h4>
                ...
                <div class="col-lg-6 p-0" style="border-left: 4px solid #F38B71;">
                    ...
                    <div class=" mx-0 row p-5 justify-content-center bor-peach border-nb  border-nl">
                        ...
                        <h4 class="my-auto bold-m col-10 ">
                            How do you face both medical and personal challenges?
                        </h4>
                        ...
                        <p class=" italic-light-m col-12 " style="font-size:18px;">
                            ...
                            Life is full of challenges, and many of them are difficult to overcome. To cope with stress, I try to take care of myself first by getting enough rest, eating healthy, sleeping well, and exercising regularly. I start with a single step and focus on the positive side of any issue. </p>
            ...
            <div class="row  ">
                ...
                <div class="col-12 p-0">
                    ...
                    <div class=" mx-0 row px-2 py-3 justify-content-center bor-peach border-nb  ">
                        ...
                        <h4 class="my-auto bold-m col-10 ">
                            Why have you chosen your specific specialization?
                        </h4>
                    ...
                    <div class="  mx-0 row px-2 py-3 justify-content-center bor-peach border-nb ">
                        ...
                        <h4 class="my-auto bold-m col-10 ">
                            How did you find the Nutrition field interesting to you?
                        </h4>
                    ...
                    <div class=" mx-0 row px-2 py-3 justify-content-center bor-peach border-nb ">
                        ...
                        <p class=" italic-light-m col-12 " style="font-size:18px;">
                            ...
                            Life is full of challenges, and many of them are difficult to overcome. To cope with stress,
                            I try to take care of myself first by getting enough rest, eating healthy, sleeping well,
                            and exercising regularly. I start with a single step and focus on the positive side of any issue. </p>
