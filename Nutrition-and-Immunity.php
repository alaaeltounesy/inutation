...
<head>
    ...
    <meta name="title" content=" Nutrition and Immunity">
    <meta name="description" content="Our immune system is our first line of defense against whatever we encounter. So how can help our system fight whatever diseases or infections it might encounter? Even though, there is no real scientific evidence that our life choices directly impact the strength of our immune system, observations have been made that some lifestyles can weaken or strengthen it. A balanced diet of a range of vitamins and minerals help, and healthy lifestyle factors such as getting enough sleep, regular exercise, and low stress, and a combination of all has been thought to fight infections and diseases, as you have to create harmony in your body to boost the immunity system">
    <meta name="author" content="Rewardlion">
    <meta name="keywords" content="">
    <meta property="og:title" content="Nutrition and Immunity">
    <meta property="og:description" content="Our immune system is our first line of defense against whatever we encounter. So how can help our system fight whatever diseases or infections it might encounter? Even though, there is no real scientific evidence that our life choices directly impact the strength of our immune system, observations have been made that some lifestyles can weaken or strengthen it. A balanced diet of a range of vitamins and minerals help, and healthy lifestyle factors such as getting enough sleep, regular exercise, and low stress, and a combination of all has been thought to fight infections and diseases, as you have to create harmony in your body to boost the immunity system">
    ...
    <meta property="og:image" content="https://www.inutrition4u.com/images/post2.jpg">
    <meta property="og:url" content="https://www.inutrition4u.com//Nutrition-and-Immunity">

    <meta name="twitter:image:alt" content="https://www.inutrition4u.com/images/post2.jpg">
...
-->
    <section class="sec1-blog ">
        <div class="container-fluid w-85 py-lg-5 px-lg-0  px-4">
            <div class="row mb-5">
                <div class="col-xl-8 col-lg-10 p-0 ">

                    <div class="single-article mt-xl-0 mt-5 ">
                        <!--social post decktop-->
                        <div class="row mb-5  mx-0 " style="border-bottom:1px solid #000;">
                            ...
                            <div class="col-6 p-0 datepost text-right ">
                                <p class="italic-med">12,July.2020</p>
                            </div>
                        ...
                        <div class="post mb-5 ">
                            ...
                            <h5 class="  mb-5 italic-light-m">
                                ...
                                By maintaining a healthy lifestyle, you are giving your body the best chance to fight off diseases. One of the key factors of such lifestyles is maintaining a healthy balanced diet with a focus on the intakes that can help fight diseases and infections. Here are the elements you should add to your diet:
                                <br> <img alt="Vitamin C" src="/images/Vitamin.jpg" class="w-100 mt-lg-5   my-3">

                                <br><span class="italic-SemiBold">
                                    Vitamin C <br> </span>


                                is probably the most popular to boost immunity. It can be found in
                                citrus fruits like oranges, tangerines, grapefruit, and lemons. Red
                                bell peppers are also rich in vitamin C. Vitamin C also helps you in
                                having healthy skin.



                                <img alt="" src="/images/Broccoli.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                                    Broccoli
                                    <br> </span>
                                ...
                                <img alt="Garlic" src="/images/Garlic.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                                    Garlic
                                    <br> </span>
                                ...
                                No kitchen is ever free of garlic, and besides the additional taste it gives to meals, it has immense health benefits. It slows down the hardening of arteries, as well as fight the infections that penetrated your first line of defense.

                                <br>

                                <img alt="" src="/images/Ginger.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                                    Ginger <br> </span>

                                Ginger reduces sore throat and inflammatory illnesses. As well as it helps with dizziness and feeling of nausea.

                                <br> <img alt="Yogurt" src="/images/Yogurt.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                                    Yogurt
                                    <br> </span>


                                Choose yogurt with live and active cultures like Greek Yogurt. These kinds of yogurts are rich in Vitamin D. Vitamin D deficiency leads to fatigue, sleepiness, muscle weakness, and that leads to weak immunity.

                                <br>


                                <img alt="Almond" src="/images/Almond.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                                    Almond
                                    <br> </span>
                                ...
                                Almonds are rich in vitamin E. Vitamin E is best to be absorbed with healthy fats which are found in almonds, Sunflower Seeds
                               ...
                               <br><span class="italic-SemiBold">
                                ...
                                <br>
                                <img alt="Hydrated" src="/images/Hydrated.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                            ...
                            <div class="row mb-5 pb-3  mx-0 text-left" style="border-bottom:1px solid #000;">
                                ...
                                <div class="col-md-3 col-xl-2  col-6 p-0" style="position:relative;">
                                    <button class="share-btn" style="color:black;">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="mr-1" width="9.187" height="10.022" viewBox="0 0 9.187 10.022">
                                    ...
                                    <div class="share-buttons">
                                        ...
                                        <a href="article" id="face-btn" target="_blank">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 " alt="facebook" id="facebook" width="15" height="12" viewBox="0 0 17.722 32.779">
                                        ...
                                        <a href="article" id="twitter-btn" target="_blank">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 " id="twitter" width="15" height="15" viewBox="0 0 31.442 25.546">
                                                <g id="Group_1" data-name="Group 1" transform="translate(0 0)">
                                                    <path id="Path_2" data-name="Path 2" d="M31.442,51.024a13.439,13.439,0,0,1-3.714,1.018,6.41,6.41,0,0,0,2.836-3.563,12.882,12.882,0,0,1-4.087,1.56,6.445,6.445,0,0,0-11.15,4.408,6.637,6.637,0,0,0,.149,1.47A18.245,18.245,0,0,1,2.189,49.175,6.448,6.448,0,0,0,4.17,57.79,6.366,6.366,0,0,1,1.258,57v.071A6.475,6.475,0,0,0,6.422,63.4a6.433,6.433,0,0,1-1.69.212,5.7,5.7,0,0,1-1.22-.11,6.507,6.507,0,0,0,6.023,4.49,12.952,12.952,0,0,1-7.992,2.749A12.073,12.073,0,0,1,0,70.654a18.147,18.147,0,0,0,9.888,2.893c11.861,0,18.346-9.826,18.346-18.342,0-.285-.01-.56-.024-.833A12.859,12.859,0,0,0,31.442,51.024Z" transform="translate(0 -48)" />
                                                </g>
                                            </svg>
                                        </a>
                                        <a href="article" id="whatapp-btn" target="_blank">

                                            <svg xmlns="http://www.w3.org/2000/svg" id="Bold" alt="whatsapp" class="mr-3 " enable-background="new 0 0 24 24" height="15" viewBox="0 0 24 24" width="15">
                                        ...
                                        <a href="article" id="pinterest-btn" target="_blank">
                                            <svg xmlns="http://www.w3.org/2000/svg" alt="pinterest" id="Bold" enable-background="new 0 0 24 24" height="15" viewBox="0 0 24 24" width="15">
