  ...
  <path id="arrow_3_" data-name="arrow (3)" d="M22.177,17.547H9.88l4.708-4.485a.616.616,0,0,0-.85-.893L8.361,17.292a1.232,1.232,0,0,0,.011,1.754l5.367,5.112a.616.616,0,1,0,.85-.893L9.861,18.78H22.177a.616.616,0,0,0,0-1.233Z" transform="translate(-8 -12)"/>
                        ...
                        <div class="post mb-5 ">
                            ...
                            <h5 class="  mb-5 italic-light-m">
                                ...
                                <img alt="carbs" src="/images/carbs.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                                ...
                                <img alt="Fish" src="/images/Fish.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                                    Fatty Fish
                                    <br> </span> <br>
                                ...
                                <img alt="breakfast" src="/images/breakfast.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                                ...
                                <img alt="Vitamin D" src="/images/VitaminD.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                                    Vitamin D
                                    <br> </span> <br>
                                ...
                                <img alt=" Nuts and Seeds" src="/images/Nuts.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                                ...
                                <img alt="caffeine" src="/images/caffeine.jpg" class="w-100 mt-lg-5   my-3">
                                <br><span class="italic-SemiBold">
                            ...
                            <div class="row mb-5 pb-3  mx-0 text-left" style="border-bottom:1px solid #000;">
                                ...
                                <div class="col-md-3 col-xl-2  col-6 p-0" style="position:relative;">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-1" width="9.187"
                                     height="10.022" viewBox="0 0 9.187 10.022">
                                ...
                                <a href="article" id="whatapp-btn" target="_blank">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" id="Bold"  alt="whatsapp" class="mr-3 " enable-background="new 0 0 24 24" height="15" viewBox="0 0 24 24" width="15"><path d="m17.507 14.307-.009.075c-2.199-1.096-2.429-1.242-2.713-.816-.197.295-.771.964-.944 1.162-.175.195-.349.21-.646.075-.3-.15-1.263-.465-2.403-1.485-.888-.795-1.484-1.77-1.66-2.07-.293-.506.32-.578.878-1.634.1-.21.049-.375-.025-.524-.075-.15-.672-1.62-.922-2.206-.24-.584-.487-.51-.672-.51-.576-.05-.997-.042-1.368.344-1.614 1.774-1.207 3.604.174 5.55 2.714 3.552 4.16 4.206 6.804 5.114.714.227 1.365.195 1.88.121.574-.091 1.767-.721 2.016-1.426.255-.705.255-1.29.18-1.425-.074-.135-.27-.21-.57-.345z"/><path d="m20.52 3.449c-7.689-7.433-20.414-2.042-20.419 8.444 0 2.096.549 4.14 1.595 5.945l-1.696 6.162 6.335-1.652c7.905 4.27 17.661-1.4 17.665-10.449 0-3.176-1.24-6.165-3.495-8.411zm1.482 8.417c-.006 7.633-8.385 12.4-15.012 8.504l-.36-.214-3.75.975 1.005-3.645-.239-.375c-4.124-6.565.614-15.145 8.426-15.145 2.654 0 5.145 1.035 7.021 2.91 1.875 1.859 2.909 4.35 2.909 6.99z"/></svg>
                                </a>
                                <a href="article" id="pinterest-btn" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" alt="pinterest" id="Bold"
                                     enable-background="new 0 0 24 24" height="15" viewBox="0 0 24 24"
                                      width="15"><path d="m12.326 0c-6.579.001-10.076 4.216-10.076 8.812 0 2.131 1.191 4.79 3.098 5.633.544.245.472-.054.94-1.844.037-.149.018-.278-.102-.417-2.726-3.153-.532-9.635 5.751-9.635 9.093 0 7.394 12.582 1.582 12.582-1.498 0-2.614-1.176-2.261-2.631.428-1.733 1.266-3.596 1.266-4.845 0-3.148-4.69-2.681-4.69 1.49 0 1.289.456 2.159.456 2.159s-1.509 6.096-1.789 7.235c-.474 1.928.064 5.049.111 5.318.029.148.195.195.288.073.149-.195 1.973-2.797 2.484-4.678.186-.685.949-3.465.949-3.465.503.908 1.953 1.668 3.498 1.668 4.596 0 7.918-4.04 7.918-9.053-.016-4.806-4.129-8.402-9.423-8.402z"/></svg>
                                </a>
                ...
                <div class="col-xl-3 mt-4  col-lg-10 p-0 ">
                    ...
                    <a class="black mb-5" href="article">
                        ...
                        <img alt="Nutrition And Pregnancy" src="/images/post1.jpg" class="w-100 mb-5">
                    </a>
